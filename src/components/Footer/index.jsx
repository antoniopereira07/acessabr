            ...
            <div className="footer__section footer__section--second">
                <div className="footer__container">
                    <p>
                        ...
                        <small>
                            Projetado por <a href="https://github.com/cavalcantemmarcelo" target="_blank">Marcelo Cavalcante</a> e <a href="https://github.com/mja-maia/" target="">Miguel Maia</a> , desenvolvido por <a href="https://github.com/antoniopereira07" target="_blank">Antonio Pereira</a> Aluno da EBAC. 
                        </small>
                    </p>
